...
for (var i in this.__proto__){
  if (i == "$" || i == "exports" || i == "__file__") continue; // skip the objects created by openHarmony so we can reload them
...
// Add global access to $ object (survives from one script execution to the next)
this.__proto__.$ = $;